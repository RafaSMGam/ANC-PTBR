var i18n = {
	...
	IFEngine: {
		warnings: {
			...
			noData: `Nenhum dado a ser carregado...`,
		...
		menu: {
			...
			readInstructions: `Repassar as instruções`,
			quit: `Sair do jogo`,
	...
	Thesaurus: {
		...
		commands: {
			north: {
				pattern: `(ir pro |ir ao |ir )?(n(orte)?)`,
				defaultMessage: `Não é possível ir para o norte.`
			},
			south: {
				pattern: `(ir pro |ir ao |ir )?(s(ul|outh)?)`,
				defaultMessage: `Não é possível ir para o sul.`
			},
			east: {
				pattern: `(ir pro |ir ao |ir )?(l(este)?|east)`,
				defaultMessage: `Não é possível ir para o leste.`
			},
			west: {
				pattern: `(ir pro |ir ao |ir )?(o(este)?|w(est)?)`,
				defaultMessage: `Não é possível ir para o oeste.`
			},
			up: {
				pattern: `(subir|(ir pra |ir )?c(ima)?|u(p)?|sobre)`,
				defaultMessage: `Não é possível ir para cima.`
			},
			down: {
				pattern: `(descer|(ir pra |ir )?b(aixo)?|d(own)?|sob)`,
				defaultMessage: `Não é possível ir para baixo.`
			}
		},
		verbs: {
			open: {
	...
	AvventuraNelCastelloJSEngine: {
		...
		messages: {
			...
			dontBeFormal: `Me chame pelo nome, por favor.`,
		...
		verbs: {
			...
			push: {
				pattern: `(empurrar|afastar|apertar|usar)`
			},
			offer: {
			...
			wear: {
				pattern: `(colocar|vestir|por|trajar)`,
			},
			liftUp: {
			...
			pray: {
				pattern: `rezar`,
				defaultMessage: `  Deus ajuda os que ajudam a si mesmos.`
			},
			land: {
				pattern: `(atterrissar|cair|planar|pousar|virar|manobrar)`,
			...
			sitDown: {
				pattern: `(sentar(?:-se)?|deitar(?:-se)?)(?: no|na|em )?(.+)?`,
			...
			dig: {
				pattern: `cavar`,
				defaultMessage: `Não me parece muito fácil de digerir.`
			},
			eat: {
			...
			talk: {
				pattern: `(falar(?: (?:com|para|a(?:o)?))?|interrogar)`,
				defaultMessage: `Se você pensasse em vez de falar pelo menos uma vez, não seria melhor?`
			},
			listen: {
				pattern: `escutar`,
				defaultMessage: `Parado com o ouvido atento, você parece ouvir um ruído distante, como correntes sendo puxadas. Mas talvez seja só um truque da sua imaginação, por conta do distante sibilar do vento.`
			},
			buy: {
			...
			pet: {
				pattern: `(cariciar|acariciar|abracar)`
			},
			mount: {
			...
			ask: {
				pattern: `ask`,
				defaultMessage: `Ninguém está disposto a lhe oferecer o objeto do seu desejo.`
			},
			askTo: {
				pattern: `(pedir|demandar) (.+) (?:a(?:o|os)? |à ?)(.+)`,
				defaultMessage: `Ninguém está disposto a lhe oferecer o objeto do seu desejo.`
			},
			skrewOff:{
		...
		commands: {
			...
			stop: {
				pattern: `(parar|stop|fim|abandonar)`,
				answer: `Sinto muito que você queira abandonar sua exploração, justo quando......`					
			},
			inventory: {
			...
			insult: {
				pattern: `(idiota|tolo|cretino|merda|ferrado|merda|va se foder|deficiente|estupido|bosta|imbecil)`					
			},
			help: {
			...
			call: {
				...
				answer: `Em resposta, você ouve um som cavernoso distante, e leva alguns segundos para perceber que é apenas o eco de sua própria voz rouca.`
			},
			cry: {
				pattern: `chorar`,
				answer: `Agora que você já pôs pra fora, levante-se e lute como um homem!`
			},
			moves: {
				pattern: `(turnos|jogadas)`,
				answer: (moves) => `Você chegou a ${moves} jogadas.`
			},
			idiot: {
				pattern: `(id|iota)`,
				answer: `N t ntnd mt bm'`
			},
			abracadabra: {
				pattern: `abracadabra`,
				answer: `Receio que essa antiga palavra mágica esteja desgastada pelo uso excessivo.`

			},
			die: {
				pattern: `(morrer|enforcar-se|rachar-se|atirar-se)`,
				answer: `Está bem.`					
			},
			think: {
				pattern: `(pensar|raciocinar|cogitar|meditar|deduzir|solucionar)`,
				answer: `Este não parece ser o lugar certo para isso`
			},
			getOut: {
				pattern: `(sair(?: d(?:a|o)?)?|correr|escapar|fugir|caminhar|volta|retornar|ir)( (?:a )?(?:n(orte)?|s(ul)?|l(este)?|o(este)?|c(ima)?|b(aixo)?))?`,
				answer: `Estou indeciso: para que lado? (N/S/L/O/C/B)`
			},
			sleep: {
				pattern: `(dormir|descansar(-se)?)`,
				answer: `Z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z z`
			},
			maybe: {
				pattern: `(meh|sei la|talvez|provavelmente)`,
				answer: `Não seja tão indeciso!`
			},
			good: {
				pattern: `muito bem`,
				answer: `Obrigado!`
			...
			openSesame: {
				...
				answer: `Olha que isso aqui é AVENTURA NO CASTELO, não AS MIL E UMA NOITES.`
			},
			waitForMidnight:{
				pattern: `esperar meia-noite`,
				answer: `É estranho: quando se está esperando por algo, parece que o tempo nunca passa.`
			},
			sayHello: {
				pattern: `cumprimentar`,
			},
			greeting: {
				answer: `Olá. Lindo dia, não?`
			},
			hello: {
				answer: `Olá. Lindo dia, não?`
			},
			senno: {
				...
				answer: `Não é uma palavra mágica, estúpido!`
			},
			useSenno: {
				pattern: `ser humilde`,
				answer: `Este não parece ser o lugar certo para isso!`
			...
			lookForDictionary: {
				...
				callback: `Você não espera que eu procure por isso em todo o castelo!`
			},
			saySpell: {
			...
			introduceYourself: {
				...
				answer: `Você enumera profusamente seus muitos títulos honoríficos, mas parece não haver ninguém disposto a ouvi-lo.`
			},
			yes: {
		...
		instructions: [
			...
			`- COISA lista os objetos que possui,`,
			...
			`- INSTRUÇÕES repete-lhe estas descrições.`,
		...
		stripPattern: `(um|uma|o|os|a|as|de|dele|deles|dela|da|à|ao|às|aos|lhe|lhes|em|no|na|nos|nas|dentro|da|das|d'|com|sob|sobre|dentro|para|entre|dentre)`
	},
	AvventuraNelCastelloJS: {
		...
		castleDungeon: {
			...
			interactors: {
				hole: {
					...
					status: 0,
					description: `Ele é estreito e profundo: no fundo há algo que lembra um botão.`
				},
				button: {
					label: `botão`,
		...
		toolshed: {
			...
			directions: {
				up: `Para subir, você precisa levantar uma laje de pedra, que cai atrás de você.`
			}
		},
		narrowTunnel: {
			...
			interactors: {
				moulds: {
					label: `os musgos`,
					pattern: `musgo( esverdeado)?|musgos( esverdeados)?`,
					description: `Eles são fascinantes, com sua pelagem aveludada.`		
				},
				mushrooms: {
					label: `os fungos`,
					pattern: `fungo( putrescente)?|fungos( putrescentes)?`,
		...
		secretRoom: {
			...
			interactors: {
				...
				pendulumClock: {
					label: `um velho relógio de pêndulo`,
					pattern: `relogio( de pendulo)?`,
					states: [
						`parado`,
						``,
						``,
					...
					description: [
						...
						`Marca as onze e cinquenta e nove.`,
						``,
			...
			interactors: {
				...
				flag: {
					...
					onTake: [
						...
						` e, de repente, cede, fazendo-lhe perder o equilíbrio. Você cai na praça de armas.`
					],
		...
		vegetablePantry: {
			...
			interactors: {
				stains: {
					label: `as manchas`,
					pattern: `mancha( esverdeada)?|manchas( esverdeadas)?`
				}
			}
		},
		cheesePantry: {
			...
			interactors: {
				crusts: {
					label: `as crostas`,
					pattern: `crosta( comida)?|crostas( comidas)`,
					onTakeOrEat: `Não é possível que tenha TANTA fome!`
				}
			}
		},				
		gamePantry: {
			...
			interactors: {
				deer: {
					label: `o cervo`,
					pattern: `cervo|carcaca( do cervo)?`,
		...
		catapultRoom:{
			...
			interactors: {
				...
				balls: {
					label: `as bolas`,
					pattern: `(bol(?:a|as))( (de )?pedra)?`,
					onBreak: `Não seja vulgar.`
				},
				pieces: {
					label: `as peças`,
					pattern: `(pec(?:a|as)part(?:e|s))(?: (da |de )?catapulta)?`,
		...
		columnsHall: {
			...
			interactors: {
				column: {
					label: `a coluna`,
					pattern: `(?:pequen(?:a|o) )?(coluna|pilar)( (de )?pedra)?`,
		...
		portraitsGallery: {
			...
			interactors: {
				portrait: {
					label: `o retrato`,
					pattern: `(retrat(?:o|os)|pintur(?:a|as)|malcolm|tel(?:a|as))`,
					onLookQuestion: `O pintor quase conseguiu dar vida própria às faces das pessoas, especialmente no caso de Malcolm IV. Tem alguma coisa estranha nesse retrato. Preciso observar mais de perto `
				}
			}
		},
		trophiesRoom: {
			...
			interactors: {
				...
				trophies: {
					label: `troféus`,
					pattern: `trofe(?:u|us)|anim(?:al|ais)`,
				},
			},
	...
	objects: {
		...
		cat: {
			label: `um gato`,
			pattern: `(o )?(gato|gatinho)( agachado)?( no chao)?`,
			states:[ 
				``, 
				`agachado no chão`
			],
			...
			onTake: {
				...
				gotIt: `O gasto está faminto e se deixa ser pego com facilidade.`
			},
			onPet: [
				`ronf... ronf... ronf... ronf... `,
				`O gato ronrona.`
		...
		milkAndHoneyCup: {
			...
			pattern: `vasilha`,
			description: {
				full: `Está cheia de leite com mel.`, 
				empty: `Está completamente vazia.`
			},
			states: [
				`cheia de leite com mel`, 
				`vazia`
			],
			EMPTY: `A vasilha está vazia.`
		},
		milkAndHoney: {
			...
			onDrink: {
				...
				fail: `Pegue a vasilha na mão primeiro.`
			},
			onOffer: {
		...
		diamond: {
			...
			onBreak: {
				...
				success: `Ao primeiro golpe do martelo, o diamante se estilhaça em mil pedaços.`
			},
		...
		key: {
			label: `uma pequena chave`,
			pattern: `(pequena )?chave( de cristal)?`,
	...
	sequences: {
		...
		fly: {
			string: [
				`Certeza que não sei esqueceu de alguma`,
				`coisaaaaaaa`,
				`             aaa`,
				`                 aa`,
				`                    a`,
		...
		arm: {
			question: `Devo colocar meu braço no buraco `,
			answer: [
		...
		again: {
			string: [
				`É possível que você outra vez tenha se esquecido do`,
				`paraquedaaa`,
				`             aaa`,
				`                 aa`,
				`                    a`,
